...
namespace JasonCRUD_Exercise
{
    ...
    {     
        ...
        public StudentManage()
        {
            ...
            students.Add(new StudentInfo { Rollno = 101, Name = "Arun", Age = 20, Mobile = 9876543210 });
            students.Add(new StudentInfo { Rollno = 102, Name = "Bala", Age = 21, Mobile = 9876501234 });
            students.Add(new StudentInfo { Rollno = 103, Name = "Chitra", Age = 19, Mobile = 9876005678 });
        }
        ...
        {
            return students.FirstOrDefault(s => s.Mobile == mobile);
        }
